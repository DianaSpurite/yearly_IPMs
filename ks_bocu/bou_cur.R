...
bou_cur            <- read.csv( "ks_bocu/ks_bocu.csv" )
...
grow_yrs2    <- lapply( 34:70, grow_yr_plots2 )
...
write.csv( all_pars, "ks_bocu/data/all_pars.csv", row.names = F )
